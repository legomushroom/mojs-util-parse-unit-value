(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mojs-util-parse-unit-value"] = factory();
	else
		root["mojs-util-parse-unit-value"] = factory();
})(this, function() {
  ...
  (function (global, factory) {
    ...
    var parseUnitValue = exports.parseUnitValue = function (value, defaultUnit) {
      ...
      if (typeof value === 'string') {
        var match = value.match(_mojsUtilUnitsRegexp2.default);
    ...
    exports.default = parseUnitValue;
  });
});
